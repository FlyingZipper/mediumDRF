    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateField(auto_now_add=True)),
                ('updated', models.DateField(auto_now=True)),
                ('compagny', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sites', related_query_name='site', to='reviews.compagny')),
                ...
                ('product_size', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sites', related_query_name='site', to='reviews.productsize')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
